# Arkestrator Documentation

## Understanding Arkestrator

- **[How It Works](how-it-works.md)** — The hub-and-spoke model, job lifecycle, workspace modes, multi-machine setup, and the coordinator system
- **[Architecture](architecture.md)** — Component design, technology choices, data flow, and extensibility

## Getting Started

- **[Installation](installation.md)** — Desktop app, standalone server, Docker, building from source
...
- **[Contributing](contributing.md)** — Developer setup, coding standards, and PR workflow
